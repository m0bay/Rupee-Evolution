...
/** 
    ...
    ****Note - for RUPEEEVOLUTION we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of rupeeevolution coming in to a transaction
