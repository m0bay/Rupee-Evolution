...
#ifndef RUPEEEVOLUTION_ZRUPEEWALLET_H
#define RUPEEEVOLUTION_ZRUPEEWALLET_H
...
public:
    CzRUPEEWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZRUPEE(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZRUPEE(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //RUPEEEVOLUTION_ZRUPEEWALLET_H
