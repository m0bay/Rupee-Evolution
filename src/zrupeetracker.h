...
#ifndef RUPEEEVOLUTION_ZRUPEETRACKER_H
#define RUPEEEVOLUTION_ZRUPEETRACKER_H
...
public:
    CzRUPEETracker(std::string strWalletFile);
    ~CzRUPEETracker();
...
#endif //RUPEEEVOLUTION_ZRUPEETRACKER_H
