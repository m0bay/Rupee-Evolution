...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Rupee Evolution Core rupeeevolution-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  rupeeevolution-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rupeeevolution transaction") + "\n" +
                               "  rupeeevolution-tx [options] -create [commands]   " + _("Create hex-encoded rupeeevolution transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rupeeevolution transaction
