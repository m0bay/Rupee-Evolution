                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzRUPEEPathCustom = GetArg("-zrupeebackuppath", "");
    ...
    if(!strzRUPEEPathCustom.empty()) {
        ui->wallet_customzrupeebackuppath->setText(QString::fromStdString(strzRUPEEPathCustom));
        ui->wallet_customzrupeebackuppath_label->setVisible(true);
        ui->wallet_customzrupeebackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzRUPEEPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Rupee Evolution RPC console.") + "<br>" +
