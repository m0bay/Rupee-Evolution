...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("45.77.22.11", "45.77.22.11"));
        vSeeds.push_back(CDNSSeedData("140.82.49.169", "140.82.49.169"));
        vSeeds.push_back(CDNSSeedData("149.28.206.179", "149.28.206.179"));
