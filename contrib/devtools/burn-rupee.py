...
"""
burn-rupee: create a bitcoin burn address
By James C. Stroud
...
class BurnrupeeError(Exception):
    pass


class AlphabetError(BurnrupeeError):
    pass
...
def usage():
    print "usage: burn-rupee TEMPLATE"
    print
