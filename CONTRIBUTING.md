Contributing to Rupee Evolution Core
============================

The Rupee Evolution Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Rupee Evolution Core project, and is not to be
confused with overall RUPEEEVOLUTION Network Protocol consensus changes.

Whether a pull request is merged into Rupee Evolution Core rests with the project merge
...
Patches that change RUPEEEVOLUTION consensus rules are considerably more involved than
...
Where a patch set proposes to change the RUPEEEVOLUTION consensus, it must have been
...
The project leader is the release manager for each Rupee Evolution Core release.
