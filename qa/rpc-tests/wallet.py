...
#   c) node1 mines 32 blocks, so now node 0 has 60001rupee, node 1 has 4250rupee, node2 has none.
#   d) node0 sends 601 rupee to node2, in two transactions (301 rupee, then 300 rupee).
