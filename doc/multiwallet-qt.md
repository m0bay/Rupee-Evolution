...
In order to support loading of multiple wallets in rupeeevolution-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is rupeeevolution.cpp.
...
Changes to rupeeevolution.cpp
----------------------
rupeeevolution.cpp is the entry point into rupeeevolution-qt, and as such, will require some minor modifications to provide hooks for
